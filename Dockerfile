...
LABEL org.opencontainers.image.authors="chourmovs"
LABEL org.opencontainers.image.source="https://github.com/chourmovs/mopidy-gs-spotify/"
ARG TARGETPLATFORM
ARG TARGETARCH
ARG TARGETVARIANT
...
RUN wget https://github.com/chourmovs/gst-plugins-rs-chouchou/releases/download/2023-07-18/gst-plugin-spotify_0.10.10_armhf.deb
RUN apt install ./gst-plugin-spotify_0.10.10_armhf.deb
