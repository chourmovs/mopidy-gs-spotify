...
RUN wget https://github.com/chourmovs/gst-plugins-rs-chouchou/releases/download/2023-07-02/gst-plugin-spotify_0.10.9_amd64.deb
RUN apt install ./gst-plugin-spotify_0.10.9_amd64.deb
